...
public class Global extends InitializeOnce {
	...
	public static final String LOCAL_IP = StringUtil.getLocalIp();// 本机IP
	...
	public static Map<String, Object> getSettings() {
		if (settings == null)
			settings = MapUtil.create();// 2014-01-16 by liusan.dyf
	...
	public static void mergeCounters(Map<String, Object> m) {
		...
		for (Entry<String, Object> item : set) {
			counter.increment(item.getKey(), Convert.toLong(item.getValue(), 0));
		}
	...
	public static void log(String loggerName, Object content) {
		LogFactory.getLog(loggerName).warn(content);
	}
